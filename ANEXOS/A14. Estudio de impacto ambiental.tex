...
\fancyhead[R]{\small \textbf{\color{ArthroNavy}Anexo XIV: Impacto ambiental}}
...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\color{ArthroNavy}\Huge \textbf{ESTUDIO DE IMPACTO AMBIENTAL}} \\
    \vspace{0.6cm}
...
% AQUÍ SE REDACTARÁ EL CONTENIDO DEL ESTUDIO DE IMPACTO AMBIENTAL
