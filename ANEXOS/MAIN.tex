...
\vspace{0.4cm}
    ...
    \item[\large ANEXO VI: BOCETOS] \hfill 

    \vspace{0.3cm}
    
    \item[\large ANEXO VII: ILUSTRACIONES] \hfill
    
    \vspace{0.3cm}
    
    \item[\large ANEXO VIII: EVALUACIÓN MARCADO CE] \hfill

    \vspace{0.3cm}
    
    \item[\large ANEXO IX: DECLARACIÓN DE CONFORMIDAD] \hfill

    \vspace{0.3cm}
    
    \item[\large ANEXO X: GESTIÓN DE RIESGOS] \hfill

    \vspace{0.3cm}
    
    \item[\large ANEXO XI: ESTIMACIÓN DE COSTES] \hfill

    \vspace{0.3cm}
    
    \item[\large ANEXO XII: ETIQUETA E INSTRUCCIONES] \hfill

    \vspace{0.3cm}
    
    \item[\large ANEXO XIII: IMPRESIÓN 3D] \hfill

    \vspace{0.3cm}
    
    \item[\large ANEXO XIV: ESTUDIO DE IMPACTO AMBIENTAL] \hfill
