...
\fancyhead[R]{\small \textbf{\color{ArthroNavy}Anexos}}
...
\begin{titlepage}
    ...
    {\color{ArthroGray}\Huge \textbf{ANEXOS}} \\
    \vspace{0.5cm}
    ...
    \vspace{-2.25cm} % Para que el texto quede dentro de la franja azul inferior
\end{titlepage}
...
\vspace{0.4cm}
    ...
    \item[ \large ANEXO I: DESARROLLO DEL PRODUCTO] \hfill
 
    
    \vspace{0.3cm} % Reducido un poco el espacio entre bloques de anexos
    
    \item[ \large ANEXO II: DEFINICIÓN ESTRATÉGICA] \hfill 

    
    \vspace{0.3cm}
    
    \item[\large ANEXO III: PLANIFICACIÓN Y CRONOGRAMA DEL PROYECTO] \hfill 

    \vspace{0.3cm}
    
    \item[\large ANEXO IV: ENTREVISTAS Y ENCUESTAS] \hfill 

    \vspace{0.3cm}
    
    \item[\large ANEXO V: ESPECIFICACIONES DEL PRODUCTO] \hfill 

    \vspace{0.3cm}
    
    \item[\large ANEXO VI: DISEÑO CONCEPTUAL] \hfill 

    \vspace{0.3cm}
    
    \item[\large ANEXO VII: EVALUACIÓN MARCADO CE] \hfill

    \vspace{0.3cm}
    
    \item[\large ANEXO VIII: DECLARACIÓN DE CONFORMIDAD] \hfill
