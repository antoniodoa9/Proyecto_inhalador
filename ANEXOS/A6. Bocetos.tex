...
\fancyhead[R]{\small \textbf{\color{ArthroNavy}Anexo VI: Diseño conceptual}}
...
\begin{titlepage}
    ...
    \vspace{0.5cm}
    {\color{ArthroNavy}\Huge \textbf{DISEÑO CONCEPTUAL}} \\
    \vspace{0.6cm}
...
Tras la generación de las diferentes alternativas conceptuales presentadas en el apartado anterior, se procede a su evaluación sistemática mediante una matriz de selección de conceptos (Matriz de Pugh). En esta matriz se evalúan las 20 propuestas generadas frente a 7 criterios técnicos y funcionales, adaptados de las Especificaciones del Producto (Anexo V) para permitir una valoración cualitativa en fase de bocetaje.

Los criterios evaluados son los siguientes:
\begin{itemize}
    \item \textbf{A (Ergonomía de accionamiento):} El diseño visual sugiere la capacidad de sustituir el movimiento de pinza por empuje palmar para reducir el esfuerzo.
    \item \textbf{B (Facilidad de montaje/desmontaje):} La geometría propuesta parece permitir un ensamblaje intuitivo sin necesidad de herramientas ni movimientos finos.
    \item \textbf{C (Confort y seguridad de agarre):} Presencia de superficies redondeadas, zonas amplias de contacto y posibles texturas antideslizantes.
    \item \textbf{D (Viabilidad geométrica de fabricación):} Diseño simplificado que apunte a un fácil desmoldeo (o fabricación 3D) sin contrasalidas excesivas.
    \item \textbf{E (Facilidad de limpieza):} Acceso visual y físico abierto a la cavidad interior, evitando el diseño de recovecos donde se acumule suciedad.
    \item \textbf{F (Uso autónomo a una mano):} La disposición de las piezas permite deducir que el usuario podría operar el dispositivo de forma independiente.
    \item \textbf{G (Estética e identidad visual):} Aspecto general del boceto diferenciado de los competidores directos, manteniendo un carácter discreto y médico.
\end{itemize}

Para esta comparativa, se ha tomado como referencia base (DATUM) el Concepto 10. En la siguiente tabla se detallan las puntuaciones asignadas (\textbf{+}: mejor que la referencia, \textbf{-}: peor que la referencia, \textbf{S}: igual o similar), así como la suma de valores positivos y negativos para cada alternativa. Debido a la extensión de la matriz, la tabla ha sido auto-ajustada al ancho de la página.
...
\vspace{0.5cm}
En base a los resultados de la matriz, el \textbf{Concepto NÚMERO 1} obtiene el mejor balance entre puntuaciones positivas y negativas, superando las características del diseño de referencia (DATUM), por lo que se determina como la alternativa óptima a desarrollar en las fases posteriores del proyecto.
